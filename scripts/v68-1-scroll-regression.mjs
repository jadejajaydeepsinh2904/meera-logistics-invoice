...
assert.match(androidApp,/versionCode\s+8\b/,'Current Android update preserves V68 scrolling');
assert.match(androidApp,/versionName\s+"1\.5\.0"/,'Android update preserves the V68 scroll fix');

for(const rel of ['index.html','src/mobile-v68.css']){
